...
const Movie = ({ movie }) => {
  return (
    ...
    <Link href={"/" }>
    <button className='bg-gray-700 text-white py-3 px-6 rounded text-sm m-4 '>Back To Home</button>
    </Link>
      ...
      <div className="px-3">
        ...
        <p className="text-gray-600 text-sm mb-5">Release Date: <span className="font-bold">{movie.release_date}</span></p>
      </div>
